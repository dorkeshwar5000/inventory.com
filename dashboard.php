...
<body>
    ...
    <input type="submit" value="Account Info" data-toggle="modal" data-target="#myModal"><br>
    <input type="submit" value="Inventory Info" data-toggle="modal" data-target="#myModal">
    ...
    <input type="submit" value="Reports" data-toggle="modal" data-target="#myModal">
    </center>
...
<br><br><Br><br>
    ...
    <input type="submit" value="Log Out" data-toggle="modal" data-target="#myModal">
    </div>
...
display_c5()
  ...
  <!-- The Modal -->
  <div class="modal" id="myModal" class="w3-container w3-center w3-animate-zoom">
